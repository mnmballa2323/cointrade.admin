      ...
      <div className="space-y-6">
        <div className="">
          ...
          <div className="flex items-center">
            ...
            <button className="btn-gray mr-12 shrink-0">Change avatar</button>
            <div className="text-caption-2m ml-auto max-w-[calc(50%-0.75rem)] text-theme-tertiary md:hidden">
