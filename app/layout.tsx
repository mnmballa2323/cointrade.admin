  ...
  return (
    <html lang="en">
      <head>
        ...
        <meta name="description" content="Neutrade – Crypto AI UI Kit" />
        {/* Product Name */}
        <meta name="product-name" content="Neutrade – Crypto AI UI Kit" />
        {/* Twitter Card data */}
        <meta name="twitter:card" content="summary" />
        <meta name="twitter:site" content="@ui8" />
        <meta name="twitter:title" content="Neutrade – Crypto AI UI Kit" />
        <meta
        ...
        <meta
          ...
          content="Clean and minimal Crypto AI UI Design Kit"
        />
        <meta property="og:site_name" content="Neutrade – Crypto AI UI Kit" />
