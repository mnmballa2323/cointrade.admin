...
const Sending = ({ onConfirm, onClose }: SendingProps) => (
  <>
    ...
    <div className="text-base-2 mb-1 py-8 text-center">
    ...
    <div className="">
      ...
      <Option classTitle="!w-30" title="Neutrade fee" color="bg-theme-purple">
        US$0.00
      </Option>
    ...
    <button className="btn-primary mt-4 w-full" onClick={onConfirm}>
      Confirm
    </button>
  </>
);
